        ...
        <div class="bg-light">
            <div class="sef">
                <ul class="nav nav-pills">
                    ...
                    <li class="nav-item">
                      <a class="nav-link"href="Eng/index.html">Cambiar el lenguaje a ingles</a>
                    </li>
                  </ul>
            </div>
        ...
        <nav class="navbar navbar-light bg-light fixed-top">
          ...
          <div class="container-fluid">
              ...
              <form class="justify-content-end">
                  ...
                  <button class="btn btn-sm btn-outline-info me-1 position-relative" type="button" onclick="location.href='carrito.php'">
                      <svg src="bootstrap-5.1.0-dist/SVG/cart.svg" width="32" height="32" fill="currentColor" class="bi bi-cart" viewBox="0 0 16 16">
                        ...
                        <span class="position-absolute top-0 start-100 translate-middle badge rounded-pill bg-secondary" id ="CDPE">
