...
if ($verificar){
    ...
    while ($fila = $resultado->fetch_assoc()) {
        ...
        echo "<img src=\"$rutaR\" width=\"128\" height=\"128\">";
        echo "</div>";
        ...
        echo "</div>";
        echo "<div class=\"col-sm-6\">";
        echo "<a class=\"btn btn-outline-danger\" href=\"carrito.php?numcompra=".$fila['Numcompra']."\">";
    ...
    while ($fila1 = $resultado->fetch_assoc()){
        ...
        echo '<p>'.$fila1['Nombre_Producto']." ".'U$S'.$precio.'</p>';
            ...
            echo '<p>'.$fila1['Nombre_Producto'].' '.$fila1['Precio']." x ".$fila1['Cantidad']." =".$precio.'</p>';
